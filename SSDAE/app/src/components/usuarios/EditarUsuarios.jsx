        ...
        <div className="login-page">
            <div className="form">
                <form className="login-form" onSubmit={editUser} >
                    <input name="nombre" type="text" placeholder="Nombre" value={nombre} onChange={onChangeNombre} required />
                    <input name="ap_p" type="text" placeholder="Apellido paterno" value={ap_p} onChange={onChangeAp_p} required />
                    <input name="ap_m" type="text" placeholder="Apellido materno" value={ap_m} onChange={onChangeAp_m} required />
                    <input name="correo" type="text" placeholder="Correo" value={correo} onChange={onChangeCorreo} required />
                    <p ref={alerta} style={{ display: 'none' }} >*Usuario modificado</p>
